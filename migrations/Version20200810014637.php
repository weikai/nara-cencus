 ...
 */
final class Version20200810014637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE county (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ed_summary (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, county_id INT NOT NULL, ed VARCHAR(20) NOT NULL, description VARCHAR(2048) DEFAULT NULL, year SMALLINT NOT NULL, sortkey VARCHAR(20) NOT NULL, INDEX IDX_A892F9D5D83CC1 (state_id), INDEX IDX_A892F9D85E73F45 (county_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE map_image (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, state_id INT NOT NULL, county_id INT NOT NULL, city_id INT DEFAULT NULL, enum_id INT DEFAULT NULL, publication VARCHAR(20) NOT NULL, rollnum VARCHAR(20) NOT NULL, imgseq VARCHAR(10) NOT NULL, filename VARCHAR(128) NOT NULL, year SMALLINT NOT NULL, INDEX IDX_45CB4B33C54C8C93 (type_id), INDEX IDX_45CB4B335D83CC1 (state_id), INDEX IDX_45CB4B3385E73F45 (county_id), INDEX IDX_45CB4B338BAC62AF (city_id), INDEX IDX_45CB4B3317628E55 (enum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE state (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) NOT NULL, abbr VARCHAR(2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE map_image ADD CONSTRAINT FK_45CB4B33C54C8C93 FOREIGN KEY (type_id) REFERENCES record_type (id)');
        $this->addSql('ALTER TABLE map_image ADD CONSTRAINT FK_45CB4B335D83CC1 FOREIGN KEY (state_id) REFERENCES state (id)');
        $this->addSql('ALTER TABLE map_image ADD CONSTRAINT FK_45CB4B3385E73F45 FOREIGN KEY (county_id) REFERENCES county (id)');
        $this->addSql('ALTER TABLE map_image ADD CONSTRAINT FK_45CB4B338BAC62AF FOREIGN KEY (city_id) REFERENCES city (id)');
        $this->addSql('ALTER TABLE map_image ADD CONSTRAINT FK_45CB4B3317628E55 FOREIGN KEY (enum_id) REFERENCES enumeration (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE map_image DROP FOREIGN KEY FK_45CB4B338BAC62AF');
        ...
        $this->addSql('ALTER TABLE map_image DROP FOREIGN KEY FK_45CB4B3385E73F45');
        $this->addSql('ALTER TABLE enumeration DROP FOREIGN KEY FK_A4F2E183BAB47356');
        $this->addSql('ALTER TABLE map_image DROP FOREIGN KEY FK_45CB4B3317628E55');
        $this->addSql('ALTER TABLE map_image DROP FOREIGN KEY FK_45CB4B33C54C8C93');
        ...
        $this->addSql('ALTER TABLE map_image DROP FOREIGN KEY FK_45CB4B335D83CC1');
        ...
        $this->addSql('DROP TABLE map_image');
